                        ...
                        <div class="panel-body" style="border-radius:0px; padding-bottom:0px; box-shadow:2px 2px 2px 0px;">
                           <table align="center" class="table table-bordered table-hover">
                               ...
                               <?php
                                    ...
                                    $name = @$_GET['search'];
                                        $suser=mysqli_query($con,"select * from user where name like '%$name%' and reg='yes'");
                                        if(mysqli_num_rows($suser)!=0){
                                            while($u = mysqli_fetch_array($suser)){
                               ?>
                               <tr>	
                               ...
                               <?php } }else { echo '<tr>	
											<td colspan="9" align="center">No Customer Exists..!!!</td>
										</tr>';
								}}else{
                                        echo 	'<tr>	
