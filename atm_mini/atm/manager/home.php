                    ...
                    <div class="panel">
                       <div class="panel-body" style="border-radius:0px; padding-bottom:0px; box-shadow:2px 2px 2px 0px;">
                           <table align="center" class="table table-bordered table-hover table-striped">
                               <tr>
                                   <td colspan="8" align="center" style="background:#444; color:#fff; font-size:22px; border-color:#444;">Customers <b class="badge"> <?php echo $cus = mysqli_num_rows(mysqli_query($con,"select * from user where reg='yes'")); ?> </b></td>
                               </tr>
                               <tr>
                                   ...
                                   <td align="center"><b>Last Transection</b></td>
                                   <td align="center"><b>Remaining Amount</b></td>
                                   <td align="center"><b>Check Transections</b></td>
                                   <td align="center"><b>Edit Amount</b></td>
                               </tr>
                               <?php
                                    include("conn.php");
                                    $user=mysqli_query($con,"select * from user where reg='yes'");
                               ...
                               <tr>	
                                   ...
                                   <td align="center"><?php echo $u[4]?></td>
                                   <td align="center">Rs. <?php echo $u[5]?> /=</td>
                                   <td align="center"><a class="btn btn-info btn-sm" href="check.php?name=<?php echo $u[0]?>"><i class="glyphicon glyphicon-check"></i></a></td>
                                   <td align="center"><a class="btn btn-success btn-sm" href="edit.php?name=<?php echo $u[0]?>"><i class="glyphicon glyphicon-edit" ></i></a></td>
                               </tr>
                               <?php } ?>
                           </table>
                        </div>
