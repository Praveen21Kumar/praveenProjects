...
<html>		    
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="well well-sm">
                        <ul class="nav">
							...
							<li><a href="index.php?a_d"><span class="glyphicon glyphicon-cog"></span> ATM Details </a></li>
                        </ul>
                    </div>
                </div>
                 <!--
                ...
                <div class="col-sm-9" style="background:#fdfdfd">
                    <!-- container-fluid-->
					  ...
					  else if(isset($_GET['a_d'])){
                          include('atmdetails.php');
                      }
                      else{  
                    ?>
        ...
        <footer class="container-fluid" style="background:#444; font-size:19px; color:#fff;">
            <p align="center">Website Developed For mini project</p>
        </footer>
        <script src="../js/bootstrap.min.js"></script>
